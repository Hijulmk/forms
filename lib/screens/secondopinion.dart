...
class SecondOpenionForm extends StatefulWidget {
  const SecondOpenionForm({super.key});

  @override
  State<SecondOpenionForm> createState() => _SecondOpenionFormState();
}

class _SecondOpenionFormState extends State<SecondOpenionForm> {
  String? radiooptions;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text("Book your second openion")),
      ),
      body: ListView(
        children: [
          BorderedCard(
          ...
          BorderedCard(
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    child: Text("Second openion care",
                        style: TextStyle(
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    if (medicalreportList.isNotEmpty)
                      Expanded(
                        child: SizedBox(
                          height: 160,
                          child: ListView.builder(
                              shrinkWrap: true,
                              scrollDirection: Axis.horizontal,
                              itemCount: medicalreportList.length,
                              itemBuilder: (BuildContext context, int index) {
                                return Column(
                                  children: [
                                    Container(
