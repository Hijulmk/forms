...
class SurgicalCareForm extends StatefulWidget {
  const SurgicalCareForm({super.key});

  @override
  State<SurgicalCareForm> createState() => _SurgicalCareFormState();
}

class _SurgicalCareFormState extends State<SurgicalCareForm> {
  String? radiooptions;
